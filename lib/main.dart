...
class _QuizPageState extends State<QuizPage> {
  ...
  final List<Map<String, dynamic>> _questions = [
    {
      "question": "What is the capital of Bharat?",
      "options": ["New Delhi", "Kolkata", "Karachi", "Ranchi"],
      "answer": "New Delhi",
    },
    {
    ...
    {
      "question": "Largest Mammal on Earth is?",
      "options": ["Cow", "Shark", "Human", "Blue Whale"],
      "answer": "Blue Whale",
    },
    {
      "question":
    ...
    {
      "question": "Did BJP win elections in Telangana?",
      "options": ["Yes", "No"],
      "answer": "No",
    },
  ];
